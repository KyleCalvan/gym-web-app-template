...
import AdminTrainers from './AdminTrainers.tsx';
...
export const ADMIN_NAV: NavSection[] = [
  ...
  {section:'Operations', items:[{id:'trainers', label:'Trainers', ic:'★'}, {id:'promotions', label:'Promotions', ic:'◆'}]},
...
export const ADMIN_VIEWS: Record<string, ComponentType<ViewProps>> = {
  ...
  trainers: AdminTrainers as unknown as ComponentType<ViewProps>,
